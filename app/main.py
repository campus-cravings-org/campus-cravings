...
async def lifespan(app: FastAPI):
    ...
    with Session(engine) as session:
            if not session.exec(select(Place)).first():
                ...
                session.add(Place(name="Caribbean Natural Juices", description="Fresh Juices", category="Drinks", image_url="/static/img/just-juiced.jpg"))
                session.add(Place(name="Celes and Son", description="Home-style Creole Cooking", category="Creole", image_url="/static/img/celes.jpg"))
                session.add(Place(name="Maureen's Cuisine", description="Pies, Sandwiches & Snacks", category="Snacks", image_url="/static/img/maureen.jpg"))
                ...
                session.add(Place(name="Lee's Doubles", description="Doubles and local street food", category="Street Food", image_url="/static/img/doubles.jpg"))
                session.add(Place(name="Juman's Roti Shop", description="Roti and curries", category="Roti", image_url="/static/img/jumans.jpg"))
                session.add(Place(name="Pita Pit", description="Wraps and Paninis", category="Wraps", image_url="/static/img/pitapit.webp"))
                ...
                session.add(Place(name="Boba and Brew Café", description="Pastries, Smoothies and Ice Cream", category="Cafe", image_url="/static/img/boba.png"))
                session.add(Place(name="AI Mohammed", description="Burgers and sandwiches", category="Burgers", image_url="/static/img/almohammed.webp"))
                session.commit()
