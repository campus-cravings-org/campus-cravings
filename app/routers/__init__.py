...
from . import (index, login, register, admin_home, admin_reviews, admin_menu_items, user_home, users, logout, places, browse, welcome, terms, place_detail, favourites, reviews, menu)